describe('service: photoUI', function(){
  ...
  it('binds photo data from JSON to HTML and skips objects missing image paths', function(){

    //Missing thumbnailsrc
    var input = [{ title: 'a', thumbnailsrc: 'https://farm5.staticflickr.com/4375/36694607660_e3d1f831f9.jpg', imgsrc: 'https://farm5.staticflickr.com/4375/36694607660_fa924baa54_o.jpg' },
                  { title: 'b', imgsrc: 'https://farm5.staticflickr.com/4434/36920345302_e5f11135bf_o.jpg' },
                  { title: 'c', thumbnailsrc: 'https://farm5.staticflickr.com/4374/36695091770_919d940901.jpg' }];
  ...
  it('binds photo data from JSON to HTML and sets missing titles to blank', function(){

    var input = [{ thumbnailsrc: 'https://farm5.staticflickr.com/4375/36694607660_e3d1f831f9.jpg', imgsrc: 'https://farm5.staticflickr.com/4375/36694607660_fa924baa54_o.jpg' },
                  { thumbnailsrc: 'https://farm5.staticflickr.com/4434/36920345302_2a584d3c22.jpg', imgsrc: 'https://farm5.staticflickr.com/4434/36920345302_e5f11135bf_o.jpg' },
                  { title: 'c', thumbnailsrc: 'https://farm5.staticflickr.com/4374/36695091770_919d940901.jpg', imgsrc: 'https://farm5.staticflickr.com/4374/36695091770_43450af389_o.jpg' }];

    var expected =  '<div>'
                    + '<img alt="" src="https://farm5.staticflickr.com/4375/36694607660_e3d1f831f9.jpg" data-image="https://farm5.staticflickr.com/4375/36694607660_fa924baa54_o.jpg" data-description="">'
                    + '<img alt="" src="https://farm5.staticflickr.com/4434/36920345302_2a584d3c22.jpg" data-image="https://farm5.staticflickr.com/4434/36920345302_e5f11135bf_o.jpg" data-description="">'
                    + '<img alt="c" src="https://farm5.staticflickr.com/4374/36695091770_919d940901.jpg" data-image="https://farm5.staticflickr.com/4374/36695091770_43450af389_o.jpg" data-description="c">'
                    + '</div>';
